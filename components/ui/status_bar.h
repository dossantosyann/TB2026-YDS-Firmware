/**
 * @file status_bar.h
 * @brief Global battery overlay drawn on top of every screen.
 */
#pragma once
 ...
 * @ingroup ui
 * @brief Permanent top bar shared by every screen; currently shows battery percent.
 * @{
 */
 ...
 * draws the battery percentage right-aligned. Screens are expected to keep their
